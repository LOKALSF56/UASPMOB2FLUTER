...
class TambahMknsiangScreen extends StatefulWidget {
  final String userId;
  const TambahMknsiangScreen({required this.userId, Key? key})
      : super(key: key);

  @override
  _TambahMknsiangScreennState createState() => _TambahMknsiangScreennState();
}

class _TambahMknsiangScreennState extends State<TambahMknsiangScreen> {
  ...
  void saveCalories() async {
    ...
    if (snapshot.docs.isNotEmpty) {
      ...
      snapshot.docs.first.reference.update({'mknsiang': totalCalories});
    } else {
