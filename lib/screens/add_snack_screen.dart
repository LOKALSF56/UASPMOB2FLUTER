...
class TambahCemilanScreen extends StatefulWidget {
  final String userId;
  const TambahCemilanScreen({required this.userId, Key? key}) : super(key: key);

  @override
  _TambahCemilanScreenState createState() => _TambahCemilanScreenState();
}

class _TambahCemilanScreenState extends State<TambahCemilanScreen> {
  ...
  void saveCalories() async {
    ...
    if (snapshot.docs.isNotEmpty) {
      ...
      snapshot.docs.first.reference.update({'cemilan': totalCalories});
    } else {
