...
class TambahSarapanScreen extends StatefulWidget {
  final String userId;
  const TambahSarapanScreen({required this.userId, Key? key}) : super(key: key);

  @override
  _TambahSarapanScreenState createState() => _TambahSarapanScreenState();
}

class _TambahSarapanScreenState extends State<TambahSarapanScreen> {
  ...
  void saveCalories() async {
    ...
    if (snapshot.docs.isNotEmpty) {
      ...
      snapshot.docs.first.reference.update({'sarapan': totalCalories});
    } else {
